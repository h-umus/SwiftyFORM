...
public class DumpVisitor: FormItemVisitor {
    ...
    public func visit(object: AttributedTextViewFormItem) {
        dict["class"] = "AttributedTextViewFormItem"
        dict["elementIdentifier"] = object.elementIdentifier
        dict["styleIdentifier"] = object.styleIdentifier
        dict["styleClass"] = object.styleClass
        dict["title"] = object.title?.string
    ...
    public func visit(object: AttributedTextViewSwitchFormItem) {
        dict["class"] = "AttributedTextViewSwitchFormItem"
        dict["elementIdentifier"] = object.elementIdentifier
        dict["styleIdentifier"] = object.styleIdentifier
        dict["styleClass"] = object.styleClass
        dict["title"] = object.title?.string
    ...
    public func visit(object: AttributedTextViewControllerFormItem) {
        dict["class"] = "AttributedTextViewControllerFormItem"
        dict["elementIdentifier"] = object.elementIdentifier
        dict["styleIdentifier"] = object.styleIdentifier
        dict["styleClass"] = object.styleClass
        dict["title"] = object.title?.string
